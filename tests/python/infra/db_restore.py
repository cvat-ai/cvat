...
class PsycopgDatabaseRestorer:
    ...
    - In local benchmark runs (120 restore operations), this path averaged
      ~22 ms/restore vs ~92 ms/restore for the old one-shot shell approach
      (`docker exec ... psql`), i.e. about 4.1x faster.
    """
