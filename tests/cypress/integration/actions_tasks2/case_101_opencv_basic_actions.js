...
context('OpenCV. Intelligent scissors. Histogram Equalization.', () => {
    ...
    describe(`Testing case "${caseId}"`, () => {
        ...
        it('Create a shape with "TrackerMIL". Track letters for several frames', () => {
            cy.opencvOpenTab(createOpencvTrackerShape);
            // cy.opencvCreateShape(createOpencvTrackerShape);
        });
    });
