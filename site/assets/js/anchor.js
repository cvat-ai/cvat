    ...
    $(function () {
        ...
        headings.forEach(function (heading) {
            if (heading.id) {
                ...
                // project override: named class so it can be excluded from the
                // site's global link hover-underline style (see _custom.scss)
                a.className = 'td-heading-anchor-link';
