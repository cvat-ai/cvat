...
Please follow the [export tasks and projects guide](/manual/advanced/backup/#backup) to
...
Please follow the [import tasks and projects guide](/manual/advanced/backup/#create-from-backup)
...
Before upgrading, please follow the [backup guide](/administration/advanced/backup_guide/)
and backup all CVAT volumes.

Follow the [upgrade guide](/administration/advanced/upgrade_guide/).
...
The status is set by the user in the [Info window](/manual/basics/top-panel/#info)
...
Follow this [guide](/administration/basics/installation/#windows-10).
...
[Advanced configuration](/manual/basics/creating_an_annotation_task/#advanced-configuration)
section.

## How to transfer CVAT to another machine

Follow the [backup/restore guide](/administration/advanced/backup_guide/#how-to-backup-all-cvat-data).
