...
([Tracking mode (basic)](/manual/basics/track-mode-basics/); [Tracking mode (advanced)](/manual/advanced/track-mode-advanced/)).

1. To create a polygon in the track mode, click the `Track` button.

   ![](/images/image184.jpg)

1. Create a polygon the same way as in the case of [Annotation with polygons](/manual/advanced/annotation-with-polygons/).
