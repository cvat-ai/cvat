...
- `MOTS`
- `ICDAR`
- `COCO` (RLE-encoded instance masks, [guide](/manual/advanced/formats/format-coco))
- `TFRecord` ([over Datumaro](https://github.com/cvat-ai/datumaro/blob/develop/docs/user_manual.md), [guide](/manual/advanced/formats/format-tfrecord)):
- `Datumaro`
