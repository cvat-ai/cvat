...
You can also use cuboids in track mode, similar to rectangles in track mode ([basics](/manual/basics/track-mode-basics/) and [advanced](/manual/advanced/track-mode-advanced/)) or [Track mode with polygons](/manual/advanced/annotation-with-polygons/track-mode-with-polygons/)
