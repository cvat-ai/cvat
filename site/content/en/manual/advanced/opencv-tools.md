...
- You can also create a boundary manually (like when
  [creating a polygon](/manual/advanced/annotation-with-polygons/manual-drawing/)) by temporarily disabling
...
- Once all the points are placed, you can complete the creation of the object
  ...
  As a result, a polygon will be created (read more about the polygons in the [annotation with polygons](/manual/advanced/annotation-with-polygons/)).
