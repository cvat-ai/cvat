...
| `Occluded`   | true or false                                          | occluded ([read more](/manual/advanced/shape-mode-advanced/)) |
...
- [Supported properties for projects list](/manual/advanced/projects/#supported-properties-for-projects-list)

- [Supported properties for tasks list](/manual/basics/tasks-page/#supported-properties-for-tasks-list)

- [Supported properties for jobs list](/manual/basics/jobs-page/#supported-properties-for-jobs-list)

- [Supported properties for cloud storages list](/manual/basics/cloud-storages/#supported-properties-for-cloud-storages-list)
...
On the [projects](/manual/advanced/projects/#projects-page), task list on the project page,
[tasks](/manual/basics/tasks-page/), [jobs](/manual/basics/jobs-page/),
and [cloud storage](/manual/basics/cloud-storages/) pages, you can use sorting and filters.
