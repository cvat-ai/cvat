...
You can find how to prepare it [here](/manual/advanced/dataset_manifest/).
...
For more information on how to attach cloud storage, see [attach cloud storage](/manual/basics/attach-cloud-storage/)
...
See more [here](/manual/advanced/data_on_fly/).
...
Then, the created tasks will be displayed on a [tasks page](/manual/basics/tasks-page/).
