...
- `Backup task` — make a backup of this task into a zip archive.
  Read more in the [backup](/manual/advanced/backup/) section.
...
| -------------- | -------------------------------------------- | ------------------------------------------- |
| `Dimension`    | `2D` or `3D`                                 | Depends on the data format <br>(read more in [creating an annotation task](/manual/basics/creating_an_annotation_task)) |
| `Status`       | `annotation`, `validation` or `completed`    |                                             |
| `Data`         | `video`, `images`                            | Depends on the data format <br>(read more in [creating an annotation task](/manual/basics/creating_an_annotation_task)) |
...
Push `Open` button to go to [task details](/manual/basics/task-details/).
