...
The way how to use filters is described in the advanced guide [here](/manual/advanced/filter/).
...
`Tracker switcher` - enable/disable [tracking](/manual/advanced/ai-tools#trackers) for the object.
