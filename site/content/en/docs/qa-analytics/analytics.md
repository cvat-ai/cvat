...
- {{< ilink "/docs/annotation/shape-mode-basics" "Shape mode">}} (the **Detections** tab).
- {{< ilink "/docs/annotation/track-mode-basics" "Track mode">}} (the **Tracking** tab).
...
| Columns with {{< ilink "/docs/annotation/types-of-shapes" "label types names">}} | The number of objects per label type. By default, the columns with zero values are hidden. |
...
| **Label ID** | The ID of the label. |
| **Label name** | The name of the label. |
| Columns with {{< ilink "/docs/annotation/types-of-shapes" "label type names">}} | The number of objects per label type. By default, the columns with zero values are hidden. |
