...
1. (Optional) To limit the use of the label to a certain
   {{< ilink "/docs/annotation/annotation-interface/controls-sidebar#shapes" "shape tool" >}},
...
The tools on the {{< ilink "/docs/annotation/annotation-interface/controls-sidebar" "Controls sidebar" >}}
