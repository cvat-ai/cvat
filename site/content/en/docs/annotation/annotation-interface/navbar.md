...
| **Run actions**         | Run annotation actions on the annotated dataset. {{< ilink "/docs/annotation/shapes-converter" "Annotations action" >}} is a feature that allows you to modify a bulk of annotations on many frames. It supports only `shape` objects. |
