...
|![Rectangle icon](/images/image167.jpg)|`Rectangle`|{{< ilink "/docs/annotation/manual-annotation/modes/shape-mode-basics" "Shape mode" >}}; {{< ilink "/docs/annotation/manual-annotation/modes/track-mode-basics" "Track mode" >}};<br/> {{< ilink "/docs/annotation/manual-annotation/shapes/annotation-with-rectangles" "Drawing by 4 points" >}}|
...
|![Tag icon](/images/image171.jpg)|`Tag`|{{< ilink "/docs/annotation/manual-annotation/shapes/annotation-with-tags" "Annotation with tags" >}}|
...
|Icon |Description |Links to section |
|-- |-- |-- |
|![Merge shapes icon](/images/image172.jpg)|`Merge Shapes`(`M`) - starts/stops the merging shapes mode. |{{< ilink "/docs/annotation/manual-annotation/modes/track-mode-basics" "Track mode (basics)" >}}|
...
|![Split icon](/images/image174.jpg)|`Split` - splits a track. |{{< ilink "/docs/annotation/manual-annotation/modes/track-mode-advanced" "Track mode (advanced)" >}}|
