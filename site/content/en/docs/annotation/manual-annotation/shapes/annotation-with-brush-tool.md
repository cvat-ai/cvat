...
- /docs/annotation/tools/annotation-with-brush-tool/
---
...
You can convert {{< ilink "/docs/annotation/auto-annotation/ai-tools" "AI tool" >}} masks to polygons.
To do this, use the following {{< ilink "/docs/annotation/auto-annotation/ai-tools" "AI tool" >}} menu:
...
For export, see {{< ilink "/docs/dataset_management/import-datasets" "Export dataset" >}}

Import follows the general {{< ilink "/docs/dataset_management/import-datasets" "import dataset" >}} procedure,
