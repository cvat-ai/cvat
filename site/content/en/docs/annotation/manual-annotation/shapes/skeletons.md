...
- /docs/annotation/tools/skeletons/
---
...
**Skeletons** can be {{< ilink "/docs/dataset_management/formats" "**exported**" >}}
in two formats: {{< ilink "/docs/dataset_management/formats/format-cvat#cvat-for-videos-export" "**CVAT for image**" >}}
and {{< ilink "/docs/dataset_management/formats/format-coco-keypoints" "**COCO Keypoints**" >}}.
...
click on the **Setup skeleton** button if you want to set up the skeleton manually, or
{{< ilink
"/docs/annotation/manual-annotation/shapes/skeletons#adding-skeleton-labels-from-the-model" "**From model**" >}}
...
5. (Optional) If you want to adjust labels, within the
   ...
   <br>The {{< ilink "/docs/annotation/manual-annotation/shapes/skeletons#skeleton-configurator" "**Skeleton configurator**" >}}
   will open, where you can
   {{< ilink "/docs/annotation/manual-annotation/shapes/skeletons#configuring-skeleton-points"
