...
a {{< ilink "/docs/annotation/tools/annotation-with-rectangles" "rectangle" >}}, you need to specify two opposite points,
...
You can rotate ellipses using a rotation point in the same way as
 {{< ilink "/docs/annotation/tools/annotation-with-rectangles#rotation-rectangle" "rectangles" >}}.
