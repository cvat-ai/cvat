...
1. (Optional) Select
   {{< ilink "/docs/annotation/create-annotation-task#add-an-attribute" "**Add an attribute**" >}}
   and set up its properties.
1. Select {{< ilink "/docs/annotation/create-annotation-task#select-files" "**Select files**" >}}
