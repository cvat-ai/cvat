...
4. After copying the files, you can create a manifest file as described in [preapair manifest file section]({{< relref "/docs/manual/advanced/dataset_manifest" >}}):
...
3. Create a manifest. For more information, see [**Dataset manifest**]({{< relref "/docs/manual/advanced/dataset_manifest" >}}):
