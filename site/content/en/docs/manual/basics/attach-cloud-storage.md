...
4. After copying the files, you can create a manifest file as described in {{< ilink "/docs/manual/advanced/dataset_manifest" "preapair manifest file section" >}}:
...
3. Create a manifest. For more information, see {{< ilink "/docs/manual/advanced/dataset_manifest" "**Dataset manifest**" >}}:
