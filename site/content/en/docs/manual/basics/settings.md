...
- `Automatic bordering` - enable automatic bordering for polygons and polylines during drawing/editing.
  For more information To find out more, go to the section [annotation with polygons]({{< relref "/docs/manual/advanced/annotation-with-polygons" >}}).

- `Intelligent polygon cropping` - activates intelligent cropping when editing the polygon (read more in the section [edit polygon]({{< relref "/docs/manual/advanced/annotation-with-polygons/edit-polygon" >}})
