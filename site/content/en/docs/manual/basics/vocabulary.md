...
![Label](/images/image032_detrac.jpg)
...
Unique immutable and can't be changed from frame to frame (e.g. age, gender, color, etc.)
  ...
  ![Unique attribute](/images/image073.jpg)

### Temporary
Temporary mutable and can be changed on any frame (e.g. quality, pose, truncated, etc.)

  ![Temporary attribute](/images/image072.jpg)
...
![Track example](/images/gif003_detrac.gif)
...
![Approximation example](/images/approximation_accuracy.gif)
...
![Trackable object object](/images/tracker_indication_detrac.png)
