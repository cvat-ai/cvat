...
5. (Optional) To limit the use of the label to a certain [shape tool]({{< relref "/docs/manual/basics/controls-sidebar#shapes" >}}),
...
**Label shape** limits the use of the label to certain [shape tool]({{< relref "/docs/manual/basics/controls-sidebar#shapes" >}}).
...
The tools on the [Controls sidebar]({{< relref "/docs/manual/basics/controls-sidebar" >}})
...
| Connected file share | **Advanced option**. <br>Upload files from a local or cloud shared folder. <br>**Note**, that you need to mount a fileshare first. <br>For more information, see [Share path]({{< relref "/docs/administration/basics/installation#share-path" >}})                                                                                                                   |
...
| Use cache            | Select checkbox, to enable _on-the-fly_ data processing to reduce task creation time and store data in a cache with a policy of <br>evicting less popular items. <br><br>For more information, see [Data preparation on the fly]({{< relref "/docs/manual/advanced/data_on_fly" >}}).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
Created tasks will be displayed on the [tasks page]({{< relref "/docs/manual/basics/tasks-page" >}}).
