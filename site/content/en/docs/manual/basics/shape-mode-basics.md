...
1. Creating a new annotation in `Shape mode`:
   ...
   - To learn more about creating a rectangle [read here]({{< relref "/docs/manual/advanced/annotation-with-rectangles" >}}).
...
1. The following figure is an example of a fully annotated frame with separate shapes.
   ...
   Read more in the section [shape mode (advanced)]({{< relref "/docs/manual/advanced/shape-mode-advanced" >}}).
