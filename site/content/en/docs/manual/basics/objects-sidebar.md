...
The way how to use filters is described in the advanced guide [here]({{< relref "/docs/manual/advanced/filter" >}}).
...
**Tracker switcher **- enable/disable [tracking]({{< relref "/docs/manual/advanced/ai-tools#trackers" >}}) for the object.
