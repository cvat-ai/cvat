...
1. Create a [task]({{< relref "/docs/manual/basics/create_an_annotation_task" >}}), and open the task page.
2. Click **+**.
...
| Issues                  | Number of [opened issues]({{< relref "/docs/manual/advanced/analytics-and-monitoring/manual-qa" >}}). If no issues were reported, will show 0.                                                                                                |
