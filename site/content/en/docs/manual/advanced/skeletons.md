...
![Adding skeleton](/images/image-setup-skeleton-1.jpg)
...
![Skeleton configurator](/images/image-skeleton-configurator-overview.jpg)
...
![Configure skeleton point button](/images/image-skeleton-drawn-example.jpg)
...
![Menu for configuring skeleton point](/images/image-skeleton-point-setup.jpg)
...
4. Click on the model's labels, you want to use.
   ...
   ![Adding skeleton labels from model](/images/auto-annot-sk.jpg)
...
3. Select **Track** or **Shape** to annotate
   ...
   ![Annotation with skeleton start](/images/image-draw-new-skeleton.jpg)

4. Draw a skeleton on the image.

![Drawing skeleton](/images/image-draw-new-skeleton.gif)
...
2. From the drop-down list select the model.
   ...
   ![Selecting model for automatic annotation with skeletons](/images/auto-annot-sk-detectors.jpg)
...
![Editing skeleton example](/images/skeleton_editing_canvas.gif)

Upon repositioning a point, the bounding box adjusts automatically,
without affecting other points:

![Bounding box adjustment example](/images/skeleton_editing_canvas-2.gif)
...
<div style="display: flex; align-items: flex-start;">
    <img src="/images/image-skeleton-track-sidebar.jpg" alt="Skeleton parts for track mode" width="300px" />
    <img src="/images/image-skeleton-shape-sidebar.jpg" alt="Skeleton parts for shape mode" width="300px" />
</div>

Skeleton points can have properties like **Outside**, **Occluded**, and **Hidden**.

![Skeleton point properties](/images/point-properties.jpg)
