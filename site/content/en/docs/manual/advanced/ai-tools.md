...
| YOLO v8                        | YOLO v8 Segmentation is a family of instance segmentation architectures and models based on the Pytorch and Ultralytics framework. <br><br> For more information, see: <li>[GitHub: YOLO v8](https://docs.ultralytics.com/tasks/segment/) <li>[Site: YOLO v8](https://docs.ultralytics.com/tasks/segment/#models)               |
