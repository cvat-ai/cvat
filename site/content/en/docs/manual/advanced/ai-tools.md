...
| Panoptic FPN                   | Pytorch implementation of Panoptic segmentation. <br> <br><br> For more information, see: <li>[Specification: Panoptic FPN](https://paperswithcode.com/lib/detectron2/panoptic-fpn) <li>[Paper: Panoptic Segmentation](https://arxiv.org/pdf/2111.10250)<li>[Documentation: Panoptic FPN](https://detectron2.readthedocs.io/en/latest/tutorials/training.html)                                                                 |
