...
<annotations>
  ...
  <image id="Number: id of the image (the index in lexical order of images)" name="String: path to the image"
    ...
    <mask label="String: the associated label" source="manual or auto" occluded="Number: 0 - False, 1 - True" rle="RLE mask" left="Number: left of the object" top="Number: top of the object" width="Number: width of the object" height="Number: height of the object" z_order="Number: z-order of the object">
    </mask>
    ...
  </image>
  ...
