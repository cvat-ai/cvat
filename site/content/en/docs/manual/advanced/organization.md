...
![Personal workspace in organization interface](/images/user_menu_organization.png)
...
2. On the top menu, click your **Username** > **Organization** > **+ Create**.
   ...
   ![Creating organization](/images/user_menu_organization_create.png)

3. Fill in the following fields and click **Submit**.

   ![Setting up organization](/images/create_organization_form.png)
...
![Organizations page](/images/org_page.png)
...
![Opening organization settings](/images/org_page_steps.png)
...
![Inviting users to organization](/images/invite_org_members.png)
...
2. Fill in the form (see below).
   ...
   ![Invite user form](/images/org_invite_form.png)

3. Click **OK**.
4. The person being invited will receive an email with the link.

   ![Invitation email example](/images/invitation_to_org.png)
...
![Organization invitations](/images/invitations_list.png)
...
![Resending and removing invitations for organization](/images/resend_remove_invitation.png)
