...
[**choosing a subscription**]({{< relref "/docs/enterprise/subscription-managment" >}}).
...
Organization Roles are available only within the [**CVAT Organization**]({{< relref "/docs/manual/advanced/organization" >}}).
