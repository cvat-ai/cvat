...
| Panoptic FPN R101         | Panoptic FPN endows Mask R-CNN, a popular instance segmentation method, with a semantic segmentation branch using a shared Feature Pyramid Network (FPN) backbone. This allows for the model to be applied to the panoptic segmentation task. <br><br>For more information, see: <li>[Site: Panoptic FPN](https://paperswithcode.com/lib/detectron2/panoptic-fpn)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
