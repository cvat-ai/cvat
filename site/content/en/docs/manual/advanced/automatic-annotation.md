...
- [Self-hosted models deployed with Nuclio]({{< relref "/docs/manual/advanced/serverless-tutorial" >}}).
...
> you need to [install Automatic Annotation first]({{< relref "/docs/administration/advanced/installation_automatic_annotation" >}})
> and [add models]({{< relref "/docs/manual/advanced/models" >}}).
