...
| [CVAT for video 1.1](/docs/manual/advanced/formats/format-cvat/#cvat-for-videos-export)                                             | .xml          | Universal format<br> for all types of <br>annotations.      | Universal format<br> for all types of <br>annotations.                                                                                                                                  | Bounding Boxes, Polygons, <br>Polylines, Points, Cuboids, <br>Skeletons, Tags. | All attributes       | Supported     |
