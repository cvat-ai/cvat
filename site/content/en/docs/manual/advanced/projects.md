...
> Read more about [organizations]({{< relref "/docs/manual/advanced/organization" >}}).
...
1. `Tasks` — is a list of all tasks for a particular project, with the ability to search,
   ...
   [Read more about search]({{< relref "/docs/manual/advanced/search" >}}).
   [Read more about sorting and filter]({{< relref "/docs/manual/advanced/filter#sort-and-filter-projects-tasks-and-jobs" >}})
