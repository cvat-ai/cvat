...
You can backup a project or a task locally on your PC or using an {{< ilink "/docs/manual/basics/attach-cloud-storage" "attached cloud storage" >}}.
...
If you want to save a backup to a specific {{< ilink "/docs/manual/basics/attach-cloud-storage" "attached cloud storage" >}},
