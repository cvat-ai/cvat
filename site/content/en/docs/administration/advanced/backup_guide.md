...
- `cvat_events`: this is an optional volume that is used only when [Analytics component]({{< relref "/docs/administration/advanced/analytics" >}})
...
Note: CVAT containers must exist (if no, please follow the [installation guide]({{< relref "/docs/administration/basics/installation#quick-installation-guide" >}})).
