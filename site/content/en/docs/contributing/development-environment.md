...
- Install necessary dependencies:
  ...
  ```bash
  sudo apt-get update && sudo apt-get --no-install-recommends install -y build-essential curl git python3-dev python3-pip python3-venv python3-tk libldap2-dev libsasl2-dev libgeos-dev cargo libopus0
  ```
