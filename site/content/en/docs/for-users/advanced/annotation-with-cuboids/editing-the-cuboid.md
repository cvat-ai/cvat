...
You can also use cuboids in track mode, similar to rectangles in track mode ([basics](/docs/for-users/basics/track-mode-basics/) and [advanced](/docs/for-users/advanced/track-mode-advanced/)) or [Track mode with polygons](/docs/for-users/advanced/annotation-with-polygons/track-mode-with-polygons/)
