...
([Tracking mode (basic)](/docs/for-users/basics/track-mode-basics/); [Tracking mode (advanced)](/docs/for-users/advanced/track-mode-advanced/)).

1. To create a polygon in the track mode, click the `Track` button.

   ![](/images/image184.jpg)

1. Create a polygon the same way as in the case of [Annotation with polygons](/docs/for-users/advanced/annotation-with-polygons/).
