...
- `MOTS`
- `ICDAR`
- `COCO` (RLE-encoded instance masks, [guide](/docs/for-users/advanced/formats/format-coco))
- `TFRecord` ([over Datumaro](https://github.com/openvinotoolkit/datumaro/blob/develop/docs/user_manual.md), [guide](/docs/for-users/advanced/formats/format-tfrecord)):
- `Datumaro`
