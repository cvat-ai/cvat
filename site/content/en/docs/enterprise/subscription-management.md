...
- [Billing](#billing)
  - [How to add VAT/tax and other information to the CVAT invoice before the first payment?](#how-to-add-vattax-and-other-information-to-the-cvat-invoice-before-the-first-payment)
  - [How to update VAT/tax information and other details for upcoming invoices from CVAT?](#how-to-update-vattax-information-and-other-details-for-upcoming-invoices-from-cvatai)
...
This section outlines the paid plans available on CVAT.
...
and save up to 30% on CVAT usage costs.
...
### How to add VAT/tax and other information to the CVAT invoice before the first payment?

To ensure VAT (tax) information and other relevant details are included on your CVAT invoices,
it's important to add this information before making the first payment.

Here’s how you can do it:

1. Sign up for a CVAT account and log in.
...
invoices, making your financial transactions with CVAT transparent and compliant.

### How to update VAT/tax information and other details for upcoming invoices from CVAT?
...
limitations of the payment processing platform used, which in the case of CVAT, is [Stripe](https://stripe.com/).
...
- A brief outline of your project plan. This helps us understand how we might collaborate
   on a joint marketing statement highlighting your use of CVAT, and how it can benefit your project.
...
3. Provide your account details and a brief explanation of the reason for the refund:
   ...
   - Send us the username and e-mail address you’ve used to register in CVAT.
...
To renew your CVAT subscription, in the top right corner, near the nickname,
