...
Open the task and use {{< ilink "/docs/annotation/auto-annotation/ai-tools" "AI tools" >}} to start tracking
...
{{< ilink "/docs/annotation/auto-annotation/automatic-annotation" "the guide" >}}.
