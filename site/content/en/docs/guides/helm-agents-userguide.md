...
![Helm registration function](images/helm_registration_function.png)

![Helm registration logs](images/helm_registration_logs.png)
...
![CVAT Helm agent running logs](images/cvat_helm_agent_running_logs.png)
...
![CVAT Helm model ID appeared UI](images/cvat_helm_model_id_appeared_UI.png)
...
![CVAT Helm run annotation function](images/cvat_helm_run_annotation_function.png)

So now we need to decide for how many frames we want to run the tracker. Let's say 14 frames.

![Tracking 14 frames](images/cvat_helm_track_14_frames.png)

![Helm action is running](images/cvat_helm_action_is_running.png)

We can see that the agent pod is processing the task:

![Agent processing task logs](images/cvat_helm_agent_processing_task_logs.png)

So now we can see that the tracker has finished and the annotations are updated in CVAT:

![Tracking finished successfully](images/cvat_helm_tracking_worked.png)
...
![Uninstall complete](images/cvat_helm_uninstall_complete.png)
