...
linkTitle: 'Export data from CVAT'
weight: 4
description: 'This section explains how to download datasets (including annotation, images, and metadata) from projects, tasks, and jobs.'
---
...
4. (Optional) Toggle the **Save images** switch if you
   ...
   The **Save images** option is a **paid feature**. {{< product-badge "online,enterprise" >}}
   {{% /alert %}}
