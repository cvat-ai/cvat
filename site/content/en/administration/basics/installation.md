...
- Open the installed Google Chrome browser and go to [localhost:8080](http://localhost:8080).
  ...
  [CVAT manual](/manual/) for more details.
...
- [Analytics: management and monitoring of data annotation team](/administration/advanced/analytics/)
...
Please follow this [guide](/administration/advanced/installation_automatic_annotation/).
...
You can [mount](/administration/advanced/mounting_cloud_storages/)
