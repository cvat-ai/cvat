...
class ProjectAnnotationAndData:
    ...
    def import_dataset(self, dataset_file, importer, conv_mask_to_poly):
        project_data = ProjectData(
            annotation_irs=self.annotation_irs,
            db_project=self.db_project,
        ...
        importer(dataset_file, project_data, conv_mask_to_poly, self.load_dataset_data)
...
def import_dataset_as_project(project_id, dataset_file, format_name, conv_mask_to_poly):
    ...
    with open(dataset_file, 'rb') as f:
        project.import_dataset(f, importer, conv_mask_to_poly)
