...
def _export_images(dst_file, temp_dir, task_data, save_images=False, only_annotated=False):
    with GetCVATDataExtractor(
        task_data, include_images=save_images, only_annotated=only_annotated, format_type='sly_pointcloud',
