...
def _export_recognition(dst_file, temp_dir, instance_data, save_images=False, only_annotated=False):
...
def _export_localization(dst_file, temp_dir, instance_data, save_images=False, only_annotated=False):
    with GetCVATDataExtractor(instance_data, include_images=save_images, only_annotated=only_annotated) as extractor:
        dataset = Dataset.from_extractors(extractor, env=dm_env)
...
def _export_segmentation(dst_file, temp_dir, instance_data, save_images=False, only_annotated=False):
    with GetCVATDataExtractor(instance_data, include_images=save_images, only_annotated=only_annotated) as extractor:
        dataset = Dataset.from_extractors(extractor, env=dm_env)
