...
def _export(dst_file, temp_dir, instance_data, save_images=False, only_annotated=False):
    with GetCVATDataExtractor(instance_data=instance_data, include_images=save_images, only_annotated=only_annotated) as extractor:
...
def _export(dst_file, temp_dir, instance_data, save_images=False, only_annotated=False):
    with GetCVATDataExtractor(
        instance_data=instance_data, include_images=save_images, only_annotated=only_annotated,
