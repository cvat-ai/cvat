...
class CvatTaskOrJobDataExtractor(StreamingSubsetBase, CvatDataExtractorBase):
    ...
    @staticmethod
    def replace_lazy_lists(frame_data: CommonData.Frame) -> CommonData.Frame:
    ...
    def __iter__(self):
        for frame_data in self._grouped_by_frame:
            ...
            frame_data = self.replace_lazy_lists(frame_data)
...
class CVATProjectDataExtractor(StreamingDatasetBase, CvatDataExtractorBase):
    ...
    @staticmethod
    def replace_lazy_lists(frame_data: ProjectData.Frame) -> ProjectData.Frame:
        return attr.evolve(
            frame_data,
            labeled_shapes=[
                (
