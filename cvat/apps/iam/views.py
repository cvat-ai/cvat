...
def get_context(request):
    ...
    try:
        ...
        if org_id is not None and (org_slug is not None or org_header is not None):
            raise ParseError('You cannot specify "org_id" query parameter with '
        ...
        if org_slug is not None and org_header is not None and org_slug != org_header:
            raise ParseError('You cannot specify "org" query parameter and '
        ...
        raise ParseError(f'{org_slug or org_id} organization does not exist.')
