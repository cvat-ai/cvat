...
class AnnotationTime(IJobPrimaryMetric):
    ...
    def calculate(self):
        ...
        if results.result_rows[-1][1] == "in progress":
            total_annotating_time += int((self._get_utc_now() - results.result_rows[-1][0]).total_seconds())
