...
@receiver(post_save, sender=Task, dispatch_uid=__name__ + ".save_task-initialize_consensus_settings")
@receiver(post_save, sender=Job, dispatch_uid=__name__ + ".save_job-initialize_consensus_settings")
