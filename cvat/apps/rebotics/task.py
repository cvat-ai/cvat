...
def create(data: dict, retailer: User):
    ...
    retailer_name = data.get('retailer_codename', retailer.username).capitalize()
    organization = None if workspace is None else Organization.objects.get(slug=workspace)
