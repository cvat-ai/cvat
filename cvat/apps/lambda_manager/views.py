...
@extend_schema_view(retrieve=extend_schema(
    summary='Method returns the information about the function', tags=['lambda'], versions=['2.0']))
...
@extend_schema_view(retrieve=extend_schema(
    summary='Method returns the status of the request', tags=['lambda'], versions=['2.0']))
@extend_schema_view(list=extend_schema(
