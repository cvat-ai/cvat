    ...
    def __call__(self):
        ...
        try:
            if self.type == "chunk":
                ...
                return Response(
                    data="unknown data type {}.".format(self.type),
                    status=status.HTTP_400_BAD_REQUEST,
                )
        ...
        db_task = models.Task.objects.prefetch_related(
            ...
            Prefetch(
                ...
                queryset=models.Data.objects.select_related("video").prefetch_related(
                    Prefetch(
                        "images",
                        queryset=models.Image.objects.prefetch_related("related_files").order_by(
                            "frame"
                        ),
                    )
                ),
                ...
                Prefetch(
                    ...
                    queryset=models.Data.objects.select_related(
                        ...
                        Prefetch(
                            "images",
                            queryset=(
                                models.Image.objects.prefetch_related("related_files").order_by(
                                    "frame"
                                )
                            ),
                        )
        ...
        if hasattr(db_data, "video"):
            ...
            media = [
                ...
                (
                    ...
                    else SimpleNamespace(path=f"placeholder.jpg", width=f.width, height=f.height)
                )
