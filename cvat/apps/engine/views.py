...
@extend_schema_view(retrieve=extend_schema(
    ...
    responses=TaskSerializer, tags=['tasks'], versions=['1.0']))
...
@extend_schema_view(retrieve=extend_schema(
    ...
    }, tags=['cloud storages'], versions=['1.0']))
@extend_schema_view(list=extend_schema(
