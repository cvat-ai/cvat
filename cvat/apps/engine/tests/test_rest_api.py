    ...
    def _create_task(self, owner, assignee, annotation_format=""):
        ...
        with ForceLogin(owner, self.client):
            ...
            images = {
                ...
                "client_files[5]": generate_image_file("test_5.0.jpg")[1],
                "client_files[6]": generate_image_file("test_6.0.jpg")[1],
                "client_files[7]": generate_image_file("test_7.0.jpg")[1],
                "client_files[8]": generate_image_file("test_8.0.jpg")[1],
                "client_files[9]": generate_image_file("test_9.0.jpg")[1],
                "image_quality": 75,
                "frame_filter": "step=3",
            }
