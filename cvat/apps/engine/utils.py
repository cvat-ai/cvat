...
def reverse(viewname, *, args=None, kwargs=None,
    ...
    request: PatchedRequest | None = None,
) -> str:
    """
...
def get_server_url(request: PatchedRequest) -> str:
...
def sendfile(
    request: PatchedRequest, filename,
...
def is_dataset_export(request: PatchedRequest) -> bool:
