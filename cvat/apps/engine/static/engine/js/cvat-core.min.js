...
var hide = __webpack_require__(/*! ../internals/hide */ "../cvat-data/node_modules/core-js/internals/hide.js");
...
/***/ "../cvat-data/node_modules/core-js/internals/hide.js":
/*!***********************************************************!*\
  !*** ../cvat-data/node_modules/core-js/internals/hide.js ***!
  \***********************************************************/
/*! no static exports found */
...
class FrameProvider {
  ...
  _cleanup() {
    if (this._blocks.length > this._memory) {
      ...
      const [start, end] = shifted.split(':').map(el => +el); // remove all frames within this block
  ...
  startDecode(block, start, end, callback) {
    if (this._blockType === BlockType.TSVIDEO) {
      ...
      this._cleanup(); // decode(start, end, block);        
    ...
    constructor() {
      ...
      async function formats() {
        ...
        try {
          ...
          const code = errorData.response ? errorData.response.status : errorData.code;
          throw new ServerError('Could not get annotation formats from the server', code);
        }
      ...
      async function register(username, firstName, lastName, email, password1, password2) {
        ...
        try {
          ...
          const code = errorData.response ? errorData.response.status : errorData.code;
          throw new ServerError(`Could not register '${username}' user on the server`, code);
        }
      ...
      async function deleteTask(id) {
        ...
        try {
          ...
          const code = errorData.response ? errorData.response.status : errorData.code;
          throw new ServerError('Could not delete the task from the server', code);
        }
      }
      ...
      async function createTask(taskData, files, onUpdate) {
            ...
            async function checkStatus() {
              try {
                ...
                if (['Queued', 'Started'].includes(response.data.state)) {
                  ...
                  reject(new ServerError('Could not create the task on the server', 400));
                } else {
                ...
                const code = errorData.response ? errorData.response.status : errorData.code;
                reject(new ServerError('Data uploading error occurred', code));
              }
            }
        ...
        try {
          ...
          const code = errorData.response ? errorData.response.status : errorData.code;
          throw new ServerError('Could not put task to the server', code);
        }
        ...
        try {
          ...
          const code = errorData.response ? errorData.response.status : errorData.code;
          throw new ServerError('Could not put data to the server', code);
        }
      ...
      async function getSelf() {
        ...
        try {
          ...
          const code = errorData.response ? errorData.response.status : errorData.code;
          throw new ServerError('Could not get user data from the server', code);
        }
      ...
      async function getData(tid, chunk) {
        ...
        try {
          ...
          const code = errorData.response ? errorData.response.status : errorData.code;
          throw new ServerError(`Could not get chunk ${chunk} for the task ${tid} from the server`, code);
        }
