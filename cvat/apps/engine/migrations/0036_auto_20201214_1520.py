# Generated by Django 3.1.1 on 2020-12-14 15:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='task',
            name='dimension',
            field=models.CharField(choices=[('3d', 'THREED'), ('2d', 'TWOD')], default=cvat.apps.engine.models.DimensionType['TWOD'], max_length=2),
        ),
