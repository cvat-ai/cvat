...
class DataSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('chunk_size', 'size', 'image_quality', 'start_frame', 'stop_frame', 'frame_filter',
            'compressed_chunk_type', 'original_chunk_type', 'client_files', 'server_files', 'remote_files', 'clowder_files',
            'use_zip_chunks', 'cloud_storage_id', 'clowder_api_key', 'use_cache', 'copy_data', 'storage_method', 'storage')
