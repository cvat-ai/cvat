...
ANNO_DUMPERS_ROOT = os.path.join(BASE_DIR, 'anno_dumpers')
os.makedirs(ANNO_DUMPERS_ROOT, exist_ok=True)

ANNO_PARSERS_ROOT = os.path.join(BASE_DIR, 'anno_parsers')
os.makedirs(ANNO_PARSERS_ROOT, exist_ok=True)
