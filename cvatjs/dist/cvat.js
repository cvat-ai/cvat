...
(() => {
  ...
  const Exception = __webpack_require__(/*! ./exceptions */ "./babel.build/exceptions.js");
...
(() => {
  ...
  const serverProxy = __webpack_require__(/*! ./server-proxy */ "./babel.build/server-proxy.js");
  ...
  function implement(cvat) {
    ...
    const hidden = __webpack_require__(/*! ./hidden */ "./babel.build/hidden.js");
...
(() => {
  ...
  const {
    ...
    TaskStatus,
    TaskMode
  } = __webpack_require__(/*! ./enums */ "./babel.build/enums.js");
    ...
    */
    plugins: {
      /**
          ...
          *       return global.cvat.plugins.list().map((el) => {
          *         return {
          *           name: el.name,
...
const {
  Exception
} = __webpack_require__(/*! ./exceptions */ "./babel.build/exceptions.js");
  ...
  class PluginRegistry {
    static async apiWrapper(wrappedFunc, ...args) {
      ...
      for (const plugin of pluginList) {
        const pluginDecorators = plugin.filter(obj => obj.callback === wrappedFunc)[0];
...
module.exports = {"name":"cvat.js","version":"1.0.9","description":"Part of Computer Vision Tool which presents an interface for client-side integration","main":"babel.config.js","scripts":{"babel":"mkdir babel.build -p && babel src -d babel.build","webpack":"webpack","build":"npm version patch && npm run babel && npm run webpack && rm babel.build -r","test":"npm run build && node --nolazy --inspect-brk=9229 tests.js","debug":"node --nolazy --inspect-brk=9230 src/api.js","docs":"jsdoc --readme README.md src/*.js -p -c jsdoc.config.js -d docs"},"author":"Intel","license":"MIT","devDependencies":{"@babel/cli":"^7.4.3","@babel/core":"^7.4.3","@babel/preset-env":"^7.4.3","babel-eslint":"^10.0.1","jest":"^24.7.1","jsdoc":"^3.5.5","webpack":"^4.29.6","webpack-cli":"^3.3.0"},"dependencies":{"axios":"^0.18.0","error-stack-parser":"^2.0.2","js-cookie":"^2.2.0","platform":"^1.3.5","stacktrace-gps":"^3.0.2"}};
