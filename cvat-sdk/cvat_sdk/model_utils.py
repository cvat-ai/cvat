...
from cvat_sdk.exceptions import ApiAttributeError, ApiKeyError, ApiTypeError, ApiValueError
...
def to_json(obj, *, read_files: bool = True):
    ...
    if isinstance(obj, dict):
        return {key: to_json(val, read_files=read_files) for key, val in obj.items()}
