...
do
    ...
    nuctl deploy --project-name cvat --path "$func_root" \
        ...
        --env FUNCTIONS_REDIS_HOST=$(echo ${CVAT_REDIS_INMEM_HOST:-cvat_redis_ondisk}) \
        --env FUNCTIONS_REDIS_PORT=$(echo ${CVAT_REDIS_INMEM_PORT:-6666}) \
        --env FUNCTIONS_REDIS_PASSWORD=$(echo ${CVAT_REDIS_INMEM_PASSWORD}) \
