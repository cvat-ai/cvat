...
def init_context(context):
    ...
    # Read the DL model
    base_dir = "/opt/nuclio/open_model_zoo/public/text-detection-0003/FP32"
    model_xml = os.path.join(base_dir, "text-detection-0003.xml")
    model_bin = os.path.join(base_dir, "text-detection-0003.bin")
...
def handler(context, event):
    context.logger.info("Run text-detection-0003 model")
    data = event.body
