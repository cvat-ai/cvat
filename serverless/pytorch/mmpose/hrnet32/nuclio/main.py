...
def init_context(context):
    ...
    det_config = (
        "/opt/nuclio/mmpose/projects/rtmpose/rtmdet/person/rtmdet_nano_320-8xb32_coco-person.py"
    )
    ...
    pose_checkpoint = (
        "/opt/nuclio/td-hm_hrnet-w32_8xb64-210e_ubody-coco-256x192-7c227391_20230807.pth"
    )
...
def handler(context, event):
    ...
    results = []
    pred_instances = next(context.user_data.inferencer(np.array(image)[..., ::-1]))["predictions"][
        0
    ]
