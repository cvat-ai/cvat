...
class ModelHandler:
    def __init__(self):
        ...
        self.tracker = Tracker(
            name="transt", net=net, window_penalty=0.49, exemplar_size=128, instance_size=256
        )
    ...
    def encode_state(self):
        ...
        state["model.features_initialized"] = jsonpickle.encode(
            getattr(self.tracker, "features_initialized", False)
        )
