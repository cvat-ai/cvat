...
const GUIDE_URL = 'https://docs.cvat.ai';
const SHARE_MOUNT_GUIDE_URL =
    'https://docs.cvat.ai/administration/basics/installation/#share-path';
const NUCLIO_GUIDE =
    'https://docs.cvat.ai/administration/advanced/installation_automatic_annotation/';
