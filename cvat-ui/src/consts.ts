...
const GITHUB_IMAGE_URL =
    'https://raw.githubusercontent.com/opencv/cvat/develop/cvat/apps/documentation/static/' +
    'documentation/images/cvat.jpg';
const SHARE_MOUNT_GUIDE_URL =
    'https://github.com/opencv/cvat/blob/master/cvat/apps/documentation/installation.md#share-path';
const NUCLIO_GUIDE =
    'https://github.com/opencv/cvat/blob/develop/cvat/apps/documentation/' +
    'installation.md#semi-automatic-and-automatic-annotation';
