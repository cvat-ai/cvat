...
const defaultKeyMap = ({
    ...
    CHOOSE_COLOR_R: {
        name: 'Choose color channel Red',
        description: 'See the red color channel of the image',
        sequences: ['alt+r'],
        action: 'keydown',
        applicable: [DimensionType.DIM_2D],
    },
    CHOOSE_COLOR_G: {
        name: 'Choose color channel Green',
        description: 'See the green color channel of the image',
        sequences: ['ctrl+g'],
        action: 'keydown',
        applicable: [DimensionType.DIM_2D],
    },
    CHOOSE_COLOR_B: {
        name: 'Choose color channel Blue',
        description: 'See the blue color channel of the image',
        sequences: ['b'],
        action: 'keydown',
        applicable: [DimensionType.DIM_2D],
    },
    CHOOSE_FULL_RGB: {
        name: 'Choose all the color channels',
        description: 'Reset the image, to see all the color channels',
        sequences: ['alt+a'],
        action: 'keydown',
        applicable: [DimensionType.DIM_2D],
    },
