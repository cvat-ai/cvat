...
const componentShortcuts = {
    ...
    SWITCH_LOCK: {
        name: '锁定/解锁对象',
        description: '切换当前对象的锁定状态',
        sequences: ['l'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    SWITCH_ALL_HIDDEN: {
        name: '隐藏/显示所有对象',
        description: '切换侧边栏中所有对象的隐藏状态',
        sequences: ['t h'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    SWITCH_HIDDEN: {
        name: '隐藏/显示对象',
        description: '切换当前对象的隐藏状态',
        sequences: ['h'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    SWITCH_OCCLUDED: {
        name: '切换遮挡',
        description: '切换当前对象的遮挡属性',
        sequences: ['q', '/'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    SWITCH_PINNED: {
        name: '切换固定',
        description: '切换当前对象的固定属性',
        sequences: ['p'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    SWITCH_KEYFRAME: {
        name: '切换关键帧',
        description: '切换当前轨迹的关键帧属性',
        sequences: ['k'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    SWITCH_OUTSIDE: {
        name: '切换外部',
        description: '切换当前轨迹的外部属性',
        sequences: ['o'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    DELETE_OBJECT_STANDARD_WORKSPACE: {
        name: '删除对象',
        description: '删除当前对象。按住 Shift 可强制删除已锁定的对象',
        sequences: ['del', 'shift+del'],
        scope: ShortcutScope.STANDARD_WORKSPACE,
    },
    TO_BACKGROUND: {
        name: '置于后方',
        description: '将当前对象置于更后方（减小 Z 轴值）',
        sequences: ['-', '_'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    TO_FOREGROUND: {
        name: '置于前方',
        description: '将当前对象置于更前方（增大 Z 轴值）',
        sequences: ['+', '='],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    COPY_SHAPE: {
        name: '复制形状',
        description: '复制形状到 CVAT 内部剪贴板',
        sequences: ['ctrl+c'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    ...
    PROPAGATE_OBJECT: {
        name: '传播对象',
        description: '在后续帧复制该对象',
        sequences: ['ctrl+b'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    NEXT_KEY_FRAME: {
        name: '下一个关键帧',
        description: '跳转到当前轨迹的下一个关键帧',
        sequences: ['r'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    PREV_KEY_FRAME: {
        name: '上一个关键帧',
        description: '跳转到当前轨迹的上一个关键帧',
        sequences: ['e'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    CHANGE_OBJECT_COLOR: {
        name: '切换颜色',
        description: '为当前形状设置下一个颜色',
        sequences: ['enter'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
};
