...
import SVGOneLayerBackwardIcon from './assets/previous-layer-icon.svg';
import SVGOneLayerForwardIcon from './assets/next-layer-icon.svg';
...
import SVGSimplifyIcon from './assets/simplify-icon.svg';
...
import SVGAudioZoomIcon from './assets/audio-zoom-icon.svg';
import SVGAudioVolumeIcon from './assets/audio-volume-icon.svg';
import SVGAudioLoopIcon from './assets/audio-loop-icon.svg';
...
export const OneLayerBackwardIcon = React.memo((): JSX.Element => <SVGOneLayerBackwardIcon />);
export const OneLayerForwardIcon = React.memo((): JSX.Element => <SVGOneLayerForwardIcon />);
...
export const SimplifyIcon = React.memo((): JSX.Element => <SVGSimplifyIcon />);
...
export const AudioZoomIcon = React.memo((): JSX.Element => <SVGAudioZoomIcon />);
export const AudioVolumeIcon = React.memo((): JSX.Element => <SVGAudioVolumeIcon />);
export const AudioLoopIcon = React.memo((): JSX.Element => <SVGAudioLoopIcon />);
