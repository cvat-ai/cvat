...
class AudioDetailsComponent extends React.PureComponent<Props, State> {
    ...
    public render(): JSX.Element {
        ...
        return (
            <div className='cvat-task-details cvat-audio-task-details'>
...
export default connect(mapStateToProps, mapDispatchToProps)(AudioDetailsComponent);
