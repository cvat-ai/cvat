...
import ObjectSideBarComponent from '../standard-workspace/objects-side-bar/objects-side-bar';
...
import CanvasPointContextMenuComponent from '../canvas/canvas-point-context-menu';
