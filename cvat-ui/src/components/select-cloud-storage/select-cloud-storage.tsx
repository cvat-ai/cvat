...
import { AzureProvider, GoogleCloudProvider, S3Provider, BackblazeB2Provider } from 'icons';
                ...
                options={list.map((_cloudStorage) => ({
                    ...
                    label: (
                        ...
                        >
                            ...
                            {_cloudStorage.providerType === ProviderType.BACKBLAZE_B2 && <BackblazeB2Provider />}
