    ...
    return (
        <Modal
            title={
                isBulkMode ? (
                    <Text strong>
                        {`导出 ${selectedInstances.length} 个 ${instanceType}`}
                    </Text>
                ) : (
        ...
        >
            ...
            >
                ...
                <TargetStorageField
                    ...
                    storageDescription={`指定导出 ${instanceType} 的目标存储`}
                ...
                >
                    <Space>
                        ...
                        />
                        <Text strong>尽可能使用轻量备份</Text>
                        <Tooltip title='如果任务使用了来自云存储的媒体，则可以创建不包含媒体的备份。从轻量备份恢复的任务需要手动重新连接到云存储。'>
                            <QuestionCircleOutlined />
                        </Tooltip>
                    </Space>
                </Form.Item>
