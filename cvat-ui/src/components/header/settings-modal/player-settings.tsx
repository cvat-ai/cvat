        ...
        <Row key='player-speed' align='middle' className='cvat-player-settings-speed cvat-player-setting'>
            <Col>
                ...
                >
                    <Select.Option
                        key='x0.25'
                        value={FrameSpeed['x0.25']}
                        className='cvat-player-settings-speed-x025'
                    >
                        x0.25
                    </Select.Option>
                    <Select.Option
                        key='x0.5'
                        value={FrameSpeed['x0.5']}
                        className='cvat-player-settings-speed-x05'
                    >
                        x0.5
                    </Select.Option>
                    <Select.Option
                        key='x1'
                        value={FrameSpeed['x1']}
                        className='cvat-player-settings-speed-x1'
                    >
                        x1 (Normal)
                    </Select.Option>
                    <Select.Option
                        key='x1.25'
                        value={FrameSpeed['x1.25']}
                        className='cvat-player-settings-speed-x125'
                    >
                        x1.25
                    </Select.Option>
                    <Select.Option
                        key='x1.5'
                        value={FrameSpeed['x1.5']}
                        className='cvat-player-settings-speed-x15'
                    >
                        x1.5
                    </Select.Option>
                    <Select.Option
                        key='x1.75'
                        value={FrameSpeed['x1.75']}
                        className='cvat-player-settings-speed-x175'
                    >
                        x1.75
                    </Select.Option>
                    <Select.Option
                        key='x2'
                        value={FrameSpeed['x2']}
                        className='cvat-player-settings-speed-x2'
                    >
                        x2
                    </Select.Option>
                </Select>
