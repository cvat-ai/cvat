...
export const JobNotFoundComponent = React.memo(
    (): JSX.Element => (
        <Result
...
export const TaskNotFoundComponent = React.memo(
    (): JSX.Element => (
        <Result
            className='cvat-not-found'
            status='404'
...
export const ProjectNotFoundComponent = React.memo(
    (): JSX.Element => (
        <Result
            className='cvat-not-found'
            status='404'
...
export const CloudStorageNotFoundComponent = React.memo(
    (): JSX.Element => (
        <Result
            className='cvat-not-found'
            status='404'
