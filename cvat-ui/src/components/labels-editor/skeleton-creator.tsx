...
function SkeletonCreator(props: Props): JSX.Element {
    const { onCreate, labelNames } = props;
    return (
        <div className='cvat-label-constructor-creator'>
            <SkeletonForm label={null} onSubmit={onCreate} labelNames={labelNames} />
            <canvas
                width='80'
                height='80'
            />
...
export default React.memo(SkeletonCreator, compareProps);
