...
type AudioCreatorType = 'basic';

interface AudioLabelsEditorProps {
    labels: SerializedLabel[];
    onSubmit: (labels: LabelOptColor[]) => void;
}

interface AudioLabelsEditorState {
    constructorMode: ConstructorMode;
    creatorType: AudioCreatorType;
    savedLabels: LabelOptColor[];
    unsavedLabels: LabelOptColor[];
    labelForUpdate: LabelOptColor | null;
}

export default class AudioLabelsEditor extends
    React.PureComponent<AudioLabelsEditorProps, AudioLabelsEditorState> {
    public constructor(props: AudioLabelsEditorProps) {
        super(props);
    ...
    public componentDidMount(): void {
        this.componentDidUpdate((null as any) as AudioLabelsEditorProps);
    }

    public componentDidUpdate(prevProps: AudioLabelsEditorProps): void {
    ...
    public render(): JSX.Element {
        ...
        if (constructorMode === ConstructorMode.SHOW) {
            configuratorContent = (
                <AudioConstructorViewer
                    ...
                    onCreate={(_creatorType: AudioCreatorType): void => {
                        this.setState({
        ...
        return (
            <div className='cvat-audio-labels-editor'>
                <Tabs
