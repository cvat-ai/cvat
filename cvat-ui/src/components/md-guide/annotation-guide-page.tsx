...
const horizontalLine: ICommand = {
    ...commands.hr,
    buttonProps: {
        'aria-label': 'Insert horizontal line (ctrl + h)',
        title: 'Insert horizontal line (ctrl + h)',
    },
};

const editorCommands = commands.getCommands().map((cmd: ICommand) => (cmd.name === 'hr' ? horizontalLine : cmd));
    ...
    return (
        <Row justify='center' align='top' className='cvat-guide-page'>
            ...
            <Col {...dimensions}>
                ...
                <div commands={editorCommands} className='cvat-guide-page-editor-wrapper'>
                    <MDEditor
