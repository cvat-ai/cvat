...
export async function run(
    ...
    try {
        ...
        await instance.annotations.commit(
            { shapes: totalUpdates.created.shapes, tags: [], tracks: [], intervals: [] },
            { shapes: totalUpdates.deleted.shapes, tags: [], tracks: [], intervals: [] },
            frameNumbers[0],
        );
...
export async function call(
    ...
    try {
        ...
        await instance.annotations.commit(
            { shapes: processedCollection.created.shapes, tags: [], tracks: [], intervals: [] },
            { shapes: processedCollection.deleted.shapes, tags: [], tracks: [], intervals: [] },
            frame,
        );
