...
- Added intelligent function when paste labels tDon't able to choose the format for gitnot read properties of undefined (reding "filename") (<https://github.com/openvinotoolkit/cvat/pull/4187>)
