...
class IssuesApi(object):
    ...
    @overload
    def create(
        self, issue_write_request, _parse_response: typing.Literal[False], **kwargs
    ...
    def list_comments(
        ...
        >>> thread = api.list_comments(id, async_req=True)
        >>> result = thread.get()
    ...
    def list_comments_raw(self, *args, **kwargs) -> urllib3.HTTPResponse:
        """
        The same as list_comments(), but returns the response unprocessed.
        Equivalent to calling list_comments with
        _parse_response = False and _check_status=False
        ...
        Returns:
            PaginatedCommentReadList
                ...
                thread.
        """
        return self.list_comments(*args, **kwargs, _parse_response=False, _check_status=False)
