...
class Configuration(object):
    ...
    conf = cvat_api_client.Configuration(
    ...
    def __init__(
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("cvat_api_client")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if "SignatureAuthentication" in self.api_key:
    ...
    def to_debug_report(self):
        ...
        return (
            ...
            "SDK Package Version: 2.0-alpha".format(env=sys.platform, pyversion=sys.version)
        )
