...
class ExceptionRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, system, client, time, client_id, message, filename, line, column, stack, *args, **kwargs):  # noqa: E501
        """ExceptionRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, system, client, time, client_id, message, filename, line, column, stack, *args, **kwargs):  # noqa: E501
        """ExceptionRequest - a model defined in OpenAPI
