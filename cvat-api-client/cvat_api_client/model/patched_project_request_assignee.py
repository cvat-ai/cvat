...
class PatchedProjectRequestAssignee(ModelComposed):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, username, *args, **kwargs) -> PatchedProjectRequestAssignee:  # noqa: E501
        """PatchedProjectRequestAssignee - a model defined in OpenAPI
