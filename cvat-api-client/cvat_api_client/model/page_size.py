...
def lazy_import():
    ...
    globals()["PageSizeAll"] = PageSizeAll


class PageSize(ModelComposed):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, *args, **kwargs) -> PageSize:  # noqa: E501
        """PageSize - a model defined in OpenAPI
