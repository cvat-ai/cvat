...
class PageSizeAll(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PageSizeAll - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "all", must be one of ["all", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "all", must be one of ["all", ]  # noqa: E501
