...
`tests.fixtures.mp4_factory.make_cvat_chunk()`. It contains MP4 box structures, dummy AVC parameter
sets, and one dummy AVC access-unit payload sufficient to exercise CVAT's parser boundary. It is
not a recording of a person or place and contains no private, confidential, or personal data.
