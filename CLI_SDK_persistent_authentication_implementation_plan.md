...
### Task 2 — SDK client factory helpers
...
### Task 3 — CLI auth precedence resolver
...
### Task 5 — `auth list`, `auth default`, `auth logout` commands
...
### Task 6 — Docs and integration pass
