...
- Python tests now use a pytest-managed infrastructure runtime for local Docker Compose
  and Kubernetes runs, which makes the lifecycle explicit and improves speed and
