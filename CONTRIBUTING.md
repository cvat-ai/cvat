...
```sh
$ sudo apt-get update && sudo apt-get --no-install-recommends install -y build-essential nodejs npm curl redis-server python3-dev python3-pip python3-venv libldap2-dev libsasl2-dev
```
